...
public class Controlling extends Activity {
    ...
    final static String on1="92";//on
    final static String off1="79";//off

    final static String on2="91";//on
    final static String off2="78";//off


    private ProgressDialog progressDialog;
    Button btnOn1,btnOff1,btnOn2,btnOff2;
